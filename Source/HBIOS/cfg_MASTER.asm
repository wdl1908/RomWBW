...
Z180_RAMLOC	.EQU	$80		; Z180: START RAM LOCATION $80 FOR Z180, $40 FOR HD64180
;
...
;
I2CPCFENABLE	.EQU	FALSE		; ENABLE PCF8584 I2C CONTROLLER
I2CPCFBASE	.EQU	$F0		; PCF8584 BASE I/O ADDRESS
I2CPCFCLK	.EQU	I2CPCFCLK_12	; PCF CLOCK BASE: I2CPCFCLK_[3|443|6|8|12]
I2CPCFTRNS	.EQU	I2CPCFTRNS_90	; PCF TRANSFER SPEED: I2CPCFTRNS_[90|45|11|15]
;
I2CBITENABLE	.EQU	FALSE		; ENABLE I2C BIT-BANG INTERFACE
I2CBITBASE	.EQU	$20		; I2C BIT-BANG INTERFACE BASE I/O ADDRESS
;
...
LCDENABLE	.EQU	FALSE		; ENABLE LCD DISPLAY (PARALLEL BUS)
LCDBASE		.EQU	$DA		; BASE I/O ADDRESS OF LCD CONTROLLER
LCDI2CENABLE	.EQU	FALSE		; ENABLE LCD DISPLAY (I2C PCF8574 BACKPACK, ALTERNATE TO LCDENABLE)
LCDI2CADDR	.EQU	$27		; PCF8574 I2C WRITE ADDRESS
...
HDSKTRACE	.EQU	0		; HDSK: TRACE LEVEL (0=NO,1=ERRORS,2=ALL)
;
I2CEEPROMENABLE	.EQU	FALSE		; I2CEEPROM: ENABLE I2C SERIAL EEPROM DIO DRIVER (I2CEEPROM.ASM)
;
; UP TO 8 FIXED UNITS, ONE PER 24CXX CHIP-SELECT ADDRESS $50-$57 (SLOT N =
; ADDRESS $50+N). EACH SLOT IS INDEPENDENTLY ENABLED AND SIZED, SO MIXED
; CHIP TYPES ON ONE BUS ARE FINE. SHIFT SETS THE PAGE SIZE, MATCH IT TO
; YOUR CHIP BELOW (OR ITS DATASHEET IF NOT LISTED):
;   24C32:  SHIFT=5, BLKCNT=128 (4096 BYTES)
;   24C64:  SHIFT=5, BLKCNT=256 (8192 BYTES)
;   24C128: SHIFT=6, BLKCNT=256 (16384 BYTES)
;   24C256: SHIFT=6, BLKCNT=512 (32768 BYTES)
;   24C512: SHIFT=7, BLKCNT=512 (65536 BYTES)
; SHIFT MUST NOT EXCEED 7, STAGING BUFFER IS 128 BYTES, CFGTBL FORCES A
; BUILD ERROR OTHERWISE
;
I2CEEPROMADR0ENABLE .EQU FALSE		; I2CEEPROM: SLOT 0, I2C ADDR $50
I2CEEPROMSHIFT0	.EQU	5
I2CEEPROMBLKCNT0 .EQU	128
;
I2CEEPROMADR1ENABLE .EQU FALSE		; I2CEEPROM: SLOT 1, I2C ADDR $51
I2CEEPROMSHIFT1	.EQU	5
I2CEEPROMBLKCNT1 .EQU	128
;
I2CEEPROMADR2ENABLE .EQU FALSE		; I2CEEPROM: SLOT 2, I2C ADDR $52
I2CEEPROMSHIFT2	.EQU	5
I2CEEPROMBLKCNT2 .EQU	128
;
I2CEEPROMADR3ENABLE .EQU FALSE		; I2CEEPROM: SLOT 3, I2C ADDR $53
I2CEEPROMSHIFT3	.EQU	5
I2CEEPROMBLKCNT3 .EQU	128
;
I2CEEPROMADR4ENABLE .EQU FALSE		; I2CEEPROM: SLOT 4, I2C ADDR $54
I2CEEPROMSHIFT4	.EQU	5
I2CEEPROMBLKCNT4 .EQU	128
;
I2CEEPROMADR5ENABLE .EQU FALSE		; I2CEEPROM: SLOT 5, I2C ADDR $55
I2CEEPROMSHIFT5	.EQU	5
I2CEEPROMBLKCNT5 .EQU	128
;
I2CEEPROMADR6ENABLE .EQU FALSE		; I2CEEPROM: SLOT 6, I2C ADDR $56
I2CEEPROMSHIFT6	.EQU	5
I2CEEPROMBLKCNT6 .EQU	128
;
I2CEEPROMADR7ENABLE .EQU FALSE		; I2CEEPROM: SLOT 7, I2C ADDR $57
I2CEEPROMSHIFT7	.EQU	5
I2CEEPROMBLKCNT7 .EQU	128
;
...
SCSITRACE	.EQU	0		; SCSI: TRACE LEVEL (0=NO,1=ERRORS,2=ALL)
